                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <div class="calendar-events-filter">
                                        <div class="custom-control custom-control-danger custom-checkbox mb-1">
                                            ...
                                            <label class="custom-control-label" for="personal">Chưa xác nhận</label>
                                        </div>
                                        <div class="custom-control custom-control-primary custom-checkbox mb-1">
                                            ...
                                            <label class="custom-control-label" for="business">Xác nhận</label>
                                        </div>
                                        <div class="custom-control custom-control-warning custom-checkbox mb-1">
                                            ...
                                            <label class="custom-control-label" for="family">Không đến</label>
                                        </div>
                                        <div class="custom-control custom-control-success custom-checkbox mb-1">
                                            ...
                                            <label class="custom-control-label" for="holiday">Hủy</label>
                                        </div>
                                        <div class="custom-control custom-control-info custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="etc">Đã đến</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="/backend/app-assets/js/scripts/pages/app-calendar-events.js"></script>
<script src="/backend/app-assets/js/scripts/pages/app-calendar.js"></script>
