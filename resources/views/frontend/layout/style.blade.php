...
<link rel="stylesheet" href="{{asset('frontend/css/color-switcher-design.css')}}">
<!--Color Themes-->
<link rel="stylesheet" href="{{asset('frontend/css/color-themes/default-theme.css')}}" id="theme-color-file">
<!-- Favicon -->
