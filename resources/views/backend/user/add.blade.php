                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control select2 role-placeholder" name="role[]"
                                        ...
                                        <div class="col-md-10">
                                            @foreach($status as $key => $statusName)
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" name="status" id="status-{{ $key }}"
                                                           class="custom-control-input"
                                                           value="{{ $key }}" {{ old('status') === $key || $key === 'Active' ? 'checked' : '' }}>
                                                    <label class="custom-control-label"
                                                           for="status-{{ $key }}">{{ $statusName }}</label>
                                                </div>
                                            @endforeach
                                            @error('status')
                                            <p class="text-danger">{{ $message }}</p>
