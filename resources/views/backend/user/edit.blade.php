                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    'keyId' => "img_url",
                                    'inputName' => "avatar",
                                    'inputValue' => old("avatar") ?? $data->avatar,
                                    'lfmType' => 'file',
                                    'note' => '1700 x 900px',
                                    ])
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2 role-placeholder" name="role[]" multiple="multiple" style="width: 100%;" required>
                                            ...
                                            <option value="{{ $role->id }}" {{ in_array($role->name, $rolesOfUser) ? 'selected' : '' }}>
                                                {{ $role->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input type="radio" name="status" id="status-{{ $key }}" class="custom-control-input" value="{{ $key }}" {{ old('status') === $key || $data->status === $key ? 'checked' : '' }}>
