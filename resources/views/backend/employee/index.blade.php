                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- <div class="modal fade text-left" id="editinfo" tabindex="-1" aria-labelledby="myModalLabel18" aria-hidden="true" role="dialog">
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                                    ...
                                                    <div class="bs-stepper-content">
                                                        <div id="tab3" class="content">
                                                            <form>
                                                                <div class="row">
                                                                    <div class="form-group col-md-6">
                                                                        <label class="form-label" for="ename">Họ tên</label>
                                                                        <input type="text" name="name" id="ename" class="form-control" placeholder="Họ và tên" />
                                                                    </div>
                                                                    <div class="form-group col-md-6">
                                                                        <label class="form-label" for="etype">Vị trí</label>
                                                                        <select class="form-control select2" name="type" id="etype" onchange="changeType()">
                                                                            <option value=""></option>
                                                                            <option value="1">Nha sĩ</option>
                                                                            <option value="2">Thu ngân</option>
                                                                            <option value="3">Quản trị viên</option>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-md-6">
                                                                        <label class="form-label" for="ephone_number">Số điện thoại</label>
                                                                        <input type="text" name="phone_number" id="ephone_number" class="form-control" placeholder="Số điện thoại" />
                                                                    </div>
                                                                    <div class="form-group col-md-6">
                                                                        <label class="form-label" for="eemail">Email</label>
                                                                        <input type="text" name="email" id="eemail" class="form-control" placeholder="Email" />
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="form-group col-md-6">
                                                                        <label class="form-label" for="eposition">Vị trí</label>
                                                                        <input type="text" name="position" id="eposition" class="form-control" placeholder="Vị trí" />
                                                                    </div>
                                                                    <div class="form-group col-md-6">
                                                                        <label class="form-label" for="emajors">Chuyên ngành</label>
                                                                        <input type="text" name="majors" id="emajors" class="form-control" placeholder="Chuyên ngành" />
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="form-group col-md-6">
                                                                        <label class="form-label" for="eshort_description">Giới thiệu</label>
                                                                        <textarea name="short_description" id="eshort_description" class="form-control" placeholder="Giới thiệu ngắn" ></textarea>
                                                                    </div>
                                                                    <div class="form-group col-md-6 d-none service_input">
                                                                        <label for="eservice">Dịch vụ</label>
                                                                        <select id="eservice" class="select2 js-example-basic-multiple" name="service[]" multiple="multiple" required>
                                                                            <option label=" "></option>
                                                                            @foreach($services as $service)
                                                                            <option value="{{ $service->id }}">
                                                                                {{ $service->name }}
                                                        ...
                                                        <div id="tab4" class="content">
                                                            <form>
                                                                <div class="row">
                                                                    <div class="form-group col-md-6">
                                                                        <label class="form-label" for="eusername">Tên đăng nhập</label>
                                                                        <input type="text" name="username" id="eusername" class="form-control" placeholder="User name" />
                                                                    </div>
                                                                    <div class="form-group form-password-toggle col-md-6">
                                                                        <label class="form-label" for="epassword">Mật khẩu</label>
                                                                        <input type="password" id="epassword" name="password" class="form-control" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" />
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="form-group col-md-6">
                                                                        <label for="erole">Quyền</label>
                                                                        <select id="erole" class="select2 js-example-basic-multiple" name="role[]" multiple="multiple" required>
                                                                            <option label=" "></option>
                                                                            @foreach($roles as $role)
                                                                            <option value="{{ $role->id }}">
                                                                                {{ $role->name }}
