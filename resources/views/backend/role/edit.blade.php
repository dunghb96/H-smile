...
<div class="content-wrapper">
    @include('backend.layouts.content-header', ['page' => 'Cập nhật quyền'])
    <div class="row">
        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="permissions[]" id="permission-{{ $permission->id }}" class="custom-control-input" value="{{ $permission->id }}" {{ in_array($permission->id, $permissionSelected) ? 'checked' : '' }}>
